...
namespace DanmakuEngine.SourceGeneration
{
    ...
    {
        const string paramaters_base_class = @"Paramaters";

        const string argument_class = @"Argument";

        const string description_attribute = @"DescriptionAttribute";

        const string method_name = @"setupChildren";

        const string name_extension = @"InitializeChildren";

        const string usings = @"// <auto-generated/>
using DanmakuEngine.Arguments;
";

        const string generated_method = $@"private void {method_name}()";
