...
public struct RectangleI : IEquatable<RectangleI>
{
    ...
    /// <filterpriority>1</filterpriority>
    [Browsable(false)]
    public Vector2D<int> Location => new Vector2D<int>(X, Y);
    ...
    /// <filterpriority>1</filterpriority>
    [Browsable(false)]
    public Vector2D<int> Size => new Vector2D<int>(Width, Height);
    ...
    [Browsable(false)]
    public Vector2D<int> TopLeft => new Vector2D<int>(Left, Top);

    [Browsable(false)]
    public Vector2D<int> TopRight => new Vector2D<int>(Right, Top);

    [Browsable(false)]
    public Vector2D<int> BottomLeft => new Vector2D<int>(Left, Bottom);

    [Browsable(false)]
    public Vector2D<int> BottomRight => new Vector2D<int>(Right, Bottom);
    ...
    public override bool Equals([NotNullWhen(true)] object? obj)
        => obj != null && obj is RectangleI && this == (RectangleI)obj;
    ...
    public bool Contains(Vector2D<float> pt) => Contains(pt.X, pt.Y);

    public bool Contains(int x, int y) => X <= x && x < X + Width && Y <= y && y < Y + Height;

    public bool Contains(Vector2D<int> pt) => Contains(pt.X, pt.Y);
    ...
    public RectangleI Inflate(int amount) => Inflate(new Vector2D<int>(amount));

    public RectangleI Inflate(Vector2D<int> amount) => Inflate(amount.X, amount.X, amount.Y, amount.Y);
    ...
    public RectangleI Shrink(int amount) => Shrink(new Vector2D<int>(amount));

    public RectangleI Shrink(Vector2D<int> amount) => Shrink(amount.X, amount.X, amount.Y, amount.Y);
