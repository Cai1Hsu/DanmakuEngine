...
public static class Precision
{
    ...
    /// <param name="acceptableDifference">The acceptable difference. Defaults to <see cref="FLOAT_EPSILON"/>.</param>
    /// <returns>Whether <paramref name="value1"/> and <paramref name="value2"/> are almost equal.</returns>
    public static bool AlmostEquals(Vector2D<float> value1, Vector2D<float> value2, float acceptableDifference = FLOAT_EPSILON) => AlmostEquals(value1.X, value2.X, acceptableDifference) && AlmostEquals(value1.Y, value2.Y, acceptableDifference);
